        ...
        {!loading ? (
          <div className="singleContainer">
            ...
            <div className="singleRight">
              ...
              {product && product?.color?.length > 0 && (
                <div className="titlePrice">
              ...
              <div className="titlePrice">
                ...
                <div className="quantity1">
                  <button className="speech-bubble" onClick={countDec}>
                    <RemoveIcon
                      style={{
                  ...
                  <button className="speech-bubble" onClick={countInc}>
                    <AddIcon
                      style={{
                        border: "1px solid #999",
                        borderRadius: "50%",
              ...
              <div className="titlePrice">
                ...
                <div className="singleTitle" style={{ fontSize: "12px" }}>
                  {product.desc}
                </div>
              </div>
            </div>
