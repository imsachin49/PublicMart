            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className='NavAuth'>
                        {showfullSearchMenu && !isAuthPage && <form className='NavAuthItems1' onSubmit={handleSubmit}>
                        ...
                        {!isUser ? (
                            <div>
                                {!showfullSearchMenu && <Link className='NavAuthItems' onClick={() => setShowfullSearchMenu(!showfullSearchMenu)}>
                                    <LuSearch color='black' />
                                </Link>}

                                <Link className='NavAuthItems' to='/login' style={{ textDecoration: 'none', color: 'black' }}>
